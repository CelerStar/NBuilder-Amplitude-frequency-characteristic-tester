function NbuilderTcpServer(addr, port, onListenedCallback) {
	this.create(addr, port, onListenedCallback)
};

NbuilderTcpServer.prototype.setOnRecvCallback = function(cb) {
	this.onRecvCallback = cb;
};

NbuilderTcpServer.prototype.create = function(addr, port, onListenedCallback) {
...
NbuilderTcpServer.prototype.onAccept = function(self, info) {
...
NbuilderTcpServer.prototype.disconnect = function() {
